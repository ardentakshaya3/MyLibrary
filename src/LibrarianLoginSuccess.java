...
public class LibrarianLoginSuccess extends JFrame {
	static LibrarianLoginSuccess frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new LibrarianLoginSuccess();
	...
	public LibrarianLoginSuccess() {
		...
		JLabel lblLibrarianSection = new JLabel("Librarian Actions");
		...
		btnLogout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DistrictLibrary.main(new String[]{});
				frame.dispose();
			}
		});
